...
const ParentManagement = ()=>{
    ...
    const { parentsList } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libraries$2f$API$2f$ProtectedRoute$2f$secureRoutes$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProtectedRoutesApi"])();
    ...
    const handleSave = async (parentId)=>{
        ...
        if (updatedParent) {
            // await mutation.mutateAsync(updatedParent);
            setEditableData((prev)=>{
                const newState = {
                    ...prev
                };
...
//# sourceMappingURL=src_80f204._.js.map