...
var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, z: __turbopack_require_stub__ } = __turbopack_context__;
{
// InfantDoseTimingAnalysis.tsx
__turbopack_esm__({
    "default": (()=>InfantDoseTimingAnalysis)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
;
const MS_PER_DAY = 1000 * 60 * 60 * 24;
/**
 * Calculates the difference in days between the scheduled date and the actual (updated) date.
 * A positive number means the vaccine was administered early,
 * while a negative number means it was administered late.
 */ function calculateDayDifference(scheduledDate, updatedDate) {
    const scheduled = new Date(scheduledDate);
    const updated = new Date(updatedDate);
    // Divide the difference by milliseconds per day and round to the nearest day.
    return Math.round((scheduled.getTime() - updated.getTime()) / MS_PER_DAY);
}
/**
 * Given a scheduled date and an updated date, returns a predictive analysis message.
 */ function getDoseTimingMessage(scheduledDate, updatedDate, doseName) {
    const diffDays = calculateDayDifference(scheduledDate, updatedDate);
    let message = `${doseName}: `;
    if (diffDays > 0) {
        // Administered early
        message += `Administered ${diffDays} day(s) early. `;
        message += "Vaccination given before the recommended date might lead to a suboptimal immune response because the child's immune system may not be fully prepared. A booster might be needed later.";
    } else if (diffDays < 0) {
        // Administered late
        message += `Administered ${Math.abs(diffDays)} day(s) late. `;
        message += "A delayed vaccination prolongs the window of vulnerability, which could increase the risk of infection during the delay.";
    } else {
        // Administered on time
        message += "Administered on time. This is optimal for developing a robust immune response.";
    }
    return message;
}
function InfantDoseTimingAnalysis({ infantData }) {
    const schedules = infantData.Vaccination_Schedule;
    if (!schedules || schedules.length === 0) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "bg-white p-4 rounded shadow-md my-4",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                    className: "font-bold text-xl mb-4",
                    children: "Dose Timing Predictive Analysis"
                }, void 0, false, {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    children: "No vaccination schedules available for analysis."
                }, void 0, false, {
                    fileName: "[project]/src/app/home/infant/details/DoseTimingAnalysis.tsx",
                    lineNumber: 88,
                    columnNumber: 9
        ...
        children: [
            ...
            schedules.map((schedule, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            children: getDoseTimingMessage(schedule.firstDose, schedule.UpdateFirstDose, "First Dose")
                        }, void 0, false, {
                            fileName: "[project]/src/app/home/infant/details/DoseTimingAnalysis.tsx",
                            lineNumber: 101,
                            columnNumber: 11
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "mt-2",
                            children: getDoseTimingMessage(schedule.secondDose, schedule.UpdateSecondDose, "Second Dose")
                        }, void 0, false, {
                            fileName: "[project]/src/app/home/infant/details/DoseTimingAnalysis.tsx",
                            lineNumber: 108,
                            columnNumber: 11
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "mt-2",
                            children: getDoseTimingMessage(schedule.thirdDose, schedule.UpdateThirdDose, "Third Dose")
                        }, void 0, false, {
                            fileName: "[project]/src/app/home/infant/details/DoseTimingAnalysis.tsx",
                            lineNumber: 115,
                            columnNumber: 11
...
//# sourceMappingURL=src_9b2359._.js.map