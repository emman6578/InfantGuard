(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_853963._.js", {
...
const VaccineForm = ({ childData })=>{
    _s1();
    // Disable zooming on this page/component
    useDisableZoom();
    // Ref for the content to convert to PDF
    ...
    // Function to capture the content and generate a PDF with margins
    const handleSavePdf = async ()=>{
        ...
        // Create a new PDF in landscape A4 format
        const pdf = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jspdf$2f$dist$2f$jspdf$2e$es$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsPDF"]("landscape", "mm", "a4");
        ...
        // Calculate image dimensions to maintain aspect ratio and fit inside the margins
...
_s1(VaccineForm, "81QWGzG6hHYZswWPmKDCl/832cI=", false, function() {
    return [
        useDisableZoom
    ];
});
...
//# sourceMappingURL=src_853963._.js.map